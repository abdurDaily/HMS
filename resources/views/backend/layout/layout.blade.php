        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Admit Patient</span>
            </a>
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              <li>
                <a href="{{ route('admin.admit.patient') }}"> Admit Patient</a>
              </li>
              <li>
                <a href="{{ route('admin.admit.patient.list') }}"> List of Patient's </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Doctor's</span>
            </a>
            <ul id="ddmenu_3" class="collapse show dropdown-nav">
              <li>
                <a href="{{ route('admin.doctor.add') }}"> Add Doctor </a>
              </li>
              <li>
                <a href="{{ route('admin.doctor.list') }}"> List of Doctor's </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Medical Report</span>
            </a>
            <ul id="ddmenu_4" class="collapse show dropdown-nav">
              <li>
                <a href="{{ route('medical.report') }}">Report Details</a>
              </li>
              <li>
                <a href="{{ route('medical.report.create') }}"> Add Patient Reports </a>
              </li>
              <li>
                <a href="{{ route('patient.report.list') }}"> List Patient Reports </a>
              </li>
            ...
            <div class="col-lg-5 col-md-5 col-6">
              <div class="header-left d-flex align-items-center">
                <div class="menu-toggle-btn mr-15 d-flex ">
                  ...
                  <a class="main-btn primary-btn btn-hover ml-5" target="_blank" href="{{ route('home') }}">View Website<i class="lni lni-chevron-right me-2"></i> </a>
                </div>
              ...
              <div class="header-right">
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    ...
                    <li>
                      <a href="{{ route('admin.get.approve') }}">
